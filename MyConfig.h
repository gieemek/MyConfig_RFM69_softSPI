/**
 * MySensors Arduino library modified to use with RFM69 radio module with software SPI implemented
...
#define MY_ATSHA204_PIN 18 // A3 - pin where ATSHA204 is attached
